...
export function widgetLines(checklist) {
...
function paintLine(line, theme, width) {
    const raw = line.text;
    let colored;
    switch (line.kind) {
        case "header":
...
export function paintWidget(checklist, theme, width) {
...
export class ChecklistOverlay {
    ...
    cachedWidth;
    cachedLines;
    constructor(checklist, theme, cb) {
