...
import { DISPLAY_MODES, isDisplayMode } from "./types.js";
...
async function openChecklistDialog(ctx, getChecklist) {
    ...
    const options = {
        ...
        handler: async (args, ctx) => {
            ...
            if (action.name === "settings") {
                ...
                const labels = [...DISPLAY_MODES].map((m) => `${DISPLAY_MODE_LABELS[m]} — ${DISPLAY_MODE_DESCRIPTIONS[m]}`);
