...
- Pure store checks prove 10-item replacement/append work and an 11th task is rejected without changing the source checklist.
- Renderer checks prove the widget contains five task rows plus an overflow indicator and the overlay has all task views.
